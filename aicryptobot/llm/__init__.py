...
- **detail**: (string) Provide a comprehensive analysis of the market trend, justify your recommendation, and ensure to include specific technical indicators (e.g., MACD, RSI, support and resistance levels) for reference. Avoid vague statements and base the analysis on concrete data. Write at least 400 words in Chinese.
